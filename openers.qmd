...
TDLR: the most common openers are below for wordles between ${the_dates[0]} and ${the_dates[1]}. However, even the top choice `adieu` is estimated to be only ~3-4% of all openers. 
...
This indicates that `adieu` represents about 3.8% of all starters.
