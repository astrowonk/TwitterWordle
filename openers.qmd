...
TDLR: the most common openers are below for wordles between ${the_dates[0]} and ${the_dates[1]}. `Adieu` is estimated to be as high as 7.5% of all openers (based on Wordle 344 where only 1 other guess could produce the same pattern as adieu). 
