...
TDLR: the top 10 most common openers found through my method are below for Wordles between ${the_dates[0]} and ${the_dates[1]}. `Adieu` is estimated to be as high as 7.5% of all openers (based on Wordle 344 where only 1 other guess could have produced the same pattern as `adieu`). 
...
The top three I found through tweet analysis is consistent with the Top 3 the NYT's "[Wordlebot](https://www.nytimes.com/interactive/2022/upshot/wordle-bot.html)" now reports on their own site:

![Elephant](nyt_opener_stats.png)
